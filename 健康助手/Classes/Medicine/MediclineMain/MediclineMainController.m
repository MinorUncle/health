...
@interface MediclineMainController ()

@end

@implementation MediclineMainController

- (void)viewDidLoad {
    [super viewDidLoad];
    [MedicineTool initPath];
...
- (void)addAllChildControllers
{
    ...
    // 1.分页
    ClassifyController *home = [[ClassifyController alloc] init];
    [self addChildViewController:home];
    
    //收藏
    MedicineCollectController *collect = [[MedicineCollectController alloc]init];
